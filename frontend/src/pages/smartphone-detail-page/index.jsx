...
const SmartphoneDetailPage = () => {
  ...
  const getSpecifications = () => [
    { category: "Màn hình", items: [
      { name: "Kích thước", value: product?.screenSize },
      { name: "Công nghệ", value: product?.technology }
    ] },
    { category: "Hiệu năng", items: [
      { name: "CPU", value: product?.cpuCores },
      { name: "Chipset", value: product?.chipset },
      { name: "GPU", value: product?.gpu }
    ] },
    { category: "Camera", items: [
      { name: "Chính", value: product?.mainCamera },
      { name: "Ultra Wide", value: product?.cameraUltraWide },
      { name: "Telephoto", value: product?.cameraTelephoto }
    ] }
  ];
